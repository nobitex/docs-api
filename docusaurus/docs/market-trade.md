...
- **[محدودیت فراخوانی:](/#ratelimit)** 300 درخواست در هر ۱۰ دقیقه ([محدودیت مشترک](#order_ratelimit))
...
- **[محدودیت فراخوانی:](/#ratelimit)** 300 درخواست در هر دقیقه
...
- **[محدودیت فراخوانی:](/#ratelimit)** 30 درخواست در دقیقه
- **[صفحه بندی:](/#pagination)** دارد (پیش فرض ۱۰۰)
...
[details](#details) | int | `1`                                    | میزان جزئیات پاسخ، اعداد بزرگ‌تر تعداد فیلدهای بیشتری را از وضعیت هر سفارش بازمی‌گرداند | `1` یا `2`
...
<br />همچنین در صورتی که پارامتر `details=2` باشد این فیلدها نیز برای هر سفارش بازگردانده می‌شود:
...
3. این API متناظر مواردی مانند [Current Open Orders](https://binance-docs.github.io/apidocs/spot/en/#current-open-orders-user_data) و [All Orders](https://binance-docs.github.io/apidocs/spot/en/#all-orders-user_data) در اکسچنج بایننس است.
...
- **[محدودیت فراخوانی:](/#ratelimit)** 90 درخواست در دقیقه
...
- **[محدودیت فراخوانی:](/#ratelimit)** 30 درخواست در دقیقه
- **[صفحه بندی:](/#pagination)** دارد (پیش فرض ۳۰)
