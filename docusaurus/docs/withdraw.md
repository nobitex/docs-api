...
## ثبت درخواست برداشت \{#withdraw-request\}
...
* **[محدودیت فراخوانی:](/#ratelimit)** 10 درخواست در 3 دقیقه
...
### نکات و ملاحظات
1. در صورت موجود نبودن آدرس مقصد در دفتر آدرس، این درخواست نیاز به [شناسایی دوعاملی](/#dbf936619c) دارد. 
...
## تایید درخواست برداشت \{#withdraw-confirm\}
...
* **[محدودیت فراخوانی:](/#ratelimit)** 30 درخواست در ساعت
...
* **[صفحه بندی:](#pagination)** دارد (پیش فرض 20)
