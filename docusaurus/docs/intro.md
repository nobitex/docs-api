...
[راهنمای شروع به کار با API](#quickstart)
کمک بگیرید.

## احراز هویت و توکن \{#intro-auth\}
```
...
:::warning
**به هیچ عنوان توکن خود را در اختیار دیگران قرار ندهید.**
...
[صفحه تنظیمات](https://nobitex.ir/app/settings/)
...
## تغییرات و موارد قدیمی \{#intro-changelog\}
...
## راهنمای حل مشکلات \{#intro-debugging\}
...
[پشتیبانی آنلاین نوبیتکس](https://nobitex.ir/contact-us/)
در ارتباط باشید.
...
[مخزن گیت‌هاب مستندات نوبیتکس API](https://github.com/nobitex/docs-api)
...
[ثبت‌نام](https://nobitex.ir/signup/)
