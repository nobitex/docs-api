...
## لیست سفارش‌ها: اردربوک \{#orderbook-v3\}
...
- **[محدودیت فراخوانی:](/#ratelimit)** 300 درخواست در دقیقه
- **نیاز به ارسال توکن:** ندارد

:::warning
برای دریافت اردربوک حتماً از متد GET و با ارسال نماد در آدرس url استفاده نمایید. در حال حاضر در این اندپوینت متد POST پشتیبانی نمی‌شود.
:::
...
:::note
<aside class="notice">
لیست نمادهای معتبر بازارها عبارتند از:<br/>
<span class="market-symbols"></span>
</aside>
:::
...
- **[محدودیت فراخوانی:](/#ratelimit)** 60 درخواست در دقیقه
- **نیاز به ارسال توکن:** ندارد
...
:::note
لیست نمادهای معتبر بازار ها عبارتند از:
:::

پارامتر بازگشتی time زمان دقیق انجام شدن معامله است که با فرمت [یونیکس](https://fa.wikipedia.org/wiki/%D8%B3%D8%A7%D8%B9%D8%AA_%DB%8C%D9%88%D9%86%DB%8C%DA%A9%D8%B3) نمایش داده میشود
...
- **[محدودیت فراخوانی:](/#ratelimit)** 20 درخواست در دقیقه
