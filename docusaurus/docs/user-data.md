...
- **[محدودیت فراخوانی:](/#ratelimit)** ۳۰ درخواست در ساعت
...
- **[محدودیت فراخوانی:](/#ratelimit)** ۳۰ درخواست در هر ۳۰ دقیقه
...
- **[محدودیت فراخوانی:](/#ratelimit)** ۳۰ درخواست در ۳۰ دقیقه
...
- **[محدودیت فراخوانی:](/#ratelimit)** 20 درخواست در 2 دقیقه
...
2.     در برخی از موارد به دلیل کنترل بار ترافیک ورودی این سرویس، ممکن است پاسخ مورد انتظار دریافت نگردد، در این حالت می بایست مجددا فراخوانی را انجام داد و یا اینکه از [این سرویس](#1ff004071d) برای دریافت لیست کیف پول ها استفاده نمائید
...
- **[محدودیت فراخوانی:](/#ratelimit)** 15 درخواست در دقیقه
...
- **[محدودیت فراخوانی:](/#ratelimit)** ۶۰ درخواست در ۲ دقیقه
...
- **[محدودیت فراخوانی:](/#ratelimit)** ۶۰ درخواست در ۲ دقیقه
- **[صفحه بندی:](#pagination)** دارد (پیشفرض ۵۰)
...
- **[محدودیت فراخوانی:](/#ratelimit)** ۶۰ درخواست در ساعت
- **[صفحه بندی:](#pagination)** دارد (پیشفرض ۵۰)
...
- **[محدودیت فراخوانی:](/#ratelimit)** ۶۰ درخواست در ۲ دقیقه
- **[صفحه بندی:](#pagination)** دارد (پیشفرض ۱۰برای ریال و ۲۰برای سایر)
- **[فیلترزمانی:](#date-filter)** دارد
...
##  بازارهای مورد علاقه \{#favorite_market\}
...
- **[محدودیت فراخوانی:](/#ratelimit)** 6 درخواست در ۱ دقیقه
...
- **[محدودیت فراخوانی:](/#ratelimit)** 12 درخواست در ۱ دقیقه
- **نیاز به ارسال توکن:** دارد
