...
1. **دقت مقادیر پولی (monetary):** نوع monetary که در پارامترهای amount و price به کار می‌رود، بسته به بازار هر رمزارز، تعداد رقم اعشار متغیری بین ۰ تا ۸ رقم دارد. در صورت ارسال مقادیر با ارقام اعشاری بیشتر، ارقام بی‌معنی حذف (به پایین گرد) خواهند شد.<br>[مشاهده جدول دقت‌ها](https://nobitex.ir/policies/markets/ " بازارهای رمزارزی نوبیتکس
   ")
