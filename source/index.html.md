...
<a href="#auth-login">API ورود - دریافت توکن</a>
...
<h2 id="auth-login">ورود - دریافت توکن</h2>
...
```
<aside class="notice">
در صورت علاقه به دریافت لیست سفارشات همه بازارها به صورت یکجا از مقدار all برای symbol استفاده نمایید.
</aside>
