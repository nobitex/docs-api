...
##ساختار API
بستر نوبیتکس با تمرکز بر API بر روی پروتکل REST توسعه داده شده است و کاربران محترم می‌توانند به راحتی تمامی اقدامات خود در نوبیتکس را
با برنامه‌نویسی و به صورت خودکار مدیریت کنند.
این API با دریافت پارامترهای مورد نیاز هر تابع، که به صورت form-encoded یا JSON می بایست ارسال گردد، پاسخی با فرمت JSON را به شما برمی گرداند که شامل وضعیت و اطلاعات درخواستی شما می باشد.

برای دسترسی سریع‌تر
به متد مد نظر خود می‌توانید نام یا url آن را جستجو نمایید یا از منوی سمت راست صفحه استفاده کنید. برای بسیاری از متدها نیز
...
##احراز هویت
این متدها به دو بخش خصوصی و عمومی تقسیم بندی شده اند. بخش خصوصی که در ارتباط با اطلاعات حساب کاربری شما می باشد، نیاز به احراز هویت از طریق دریافت توکن دارد، 
ولی برای استفاده از متدهای عمومی نیازی به احراز هویت نیست.
پس از احراز هویت و دریافت توکن، شما می توانید از همه متدهای موجود در API استفاده نمائید.
<aside class="info">
