...
| from       | int    | الزامی  | زمان ابتدای بازه   | `1562058167` |
...
در هر درخواست بسته به بازه زمانی تعیین شده و resolution انتخابی، تعداد کندل‌های برگشتی متفاوت است.
برای مثال تعداد کندل‌های 1 ساعته از تاریخ 2019/2/9 11:39:41 تا چهار ساعت بعد آن، ۴ تاست.
