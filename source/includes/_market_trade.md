...
| clientOrderId       | string | `null` | شناسه سفارش کاربر، تا ۸ کاراکتر،‌ یکتا  برای هر کاربر و در میان سفارش های open/active (آزمایشی)          | `order1`                                      |
...
DuplicateClientOrderId | شناسه سفارش کاربر تکراری است (برای هر کاربر در لحطه فقط یه سفارش open/active با یک شماره سفارش ممکن است).
...
1. **clientOrderId**: دقت کنید که این پارامتر برای هر کاربر در میان سفارش های open/active یکتاست.
