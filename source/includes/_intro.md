...
<aside class="warning">
  <b>با توجه به بازگشایی گام به گام سرویس‌ها و امکانات نوبیتکس، دسترسی به برخی از APIها در گام بعد ایجاد می‌شود. استفاده از API های مرتبط با سرویس‌های فعال هم‌اکنون در اختیار کاربران محترم قرار گرفته است. خواهشمندیم تا زمان در دسترس قرار گرفتن کامل APIها شکیبا باشید.</b>
  <br/>
</aside>
