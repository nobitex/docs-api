...
> در صورت فعال بودن حالت برداشت امن در دفتر آدرس، نیازی به ارسال X-TOTP در هدر درخواست نیست.

> در صورت فعال نبودن حالت برداشت امن، پس از ثبت درخواست برداشت، یک کد تایید یکبارمصرف به کاربر ایمیل یا پیامک می‌شود.
...
### نکات و ملاحظات
1. در صورت فعال نبودن حالت برداشت امن، این درخواست نیاز به <a href="/#dbf936619c">شناسایی دوعاملی</a> دارد. 
