...
mobile | string | اختیاری | شماره‌ همراه کاربر گیرنده | "9127774565"
...
<aside class="notice">
محدودیت فراخوانی : 5 درخواست در 10 دقیقه
</aside>
...
##تایید دوعاملی هدیه برای کاربران عضو
برای مرحله‌ی تایید دوعاملی برای دریافت هدیه برای کاربران عضو نوبیتکس باید از این API استفاده شود.

* آدرس: `POST /gift/confirm-redeem`

* پارامترهای ورودی:

پارامتر | نوع     | پیش‌فرض | توضیحات                       | نمونه
------- |---------|---------|-------------------------------| ---------
gift_id | integer | الزامی  | شناسه‌ی کد هدیه               | 36
otp | string  | الزامی  | کد دوعاملی ارسال شده به کاربر | "386155"
...
<aside class="notice">
محدودیت فراخوانی : ۵ درخواست در 10 دقیقه
</aside>

>نمونه درخواست:

```shell
curl -X POST 'https://api.nobitex.ir/gift/confirm-redeem' \
-H 'Authorization: Token yourTOKENhereHEX0000000000' \
-H 'Content-Type: application/json' \
--data '{
    "gift_id": 37,
...
##تایید دو عاملی هدیه‌ برای کاربران غیر عضو
برای مرحله‌ی تایید دریافت هدیه برای حالت lightnign و کاربران غیر عضو از این API استفاده می‌شود.
* آدرس: `POST /gift/confirm-redeem-lightning`
...
```shell
curl -X POST 'https://api.nobitex.ir/gift/confirm-redeem-lightning' \
-H 'Content-Type: application/json' \
--data '{
    "gift_id": 37,
    "otp": "981237"
