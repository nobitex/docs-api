...
##5- تایید صحت پاسخ نوبیتکس

 پس از تایید پرداخت در مرحله 4، جواب درخواست باید از سمت نوبیتکس باشد. حملاتی تحت عنوان "مرد میانی" یا به اختصار "MIMT" وجود دارد که ممکن است جواب در خواست از سمت دیگری غیر از نوبیتکس برای شما ارسال شود.
 ...
 <br>
 <br>
 توجه شود که ترتیب قرار گیری مقادیر مهم میباشد.
<aside class="warning">
 در صورت عدم تطابق، این پاسخ از سمت نوبیتکس نبوده و نباید مورد قبول واقع شود.
</aside>
<aside class="notice">
مقدار txHash نمیتواند تکراری باشد. مقدار txHash را ذخیره نموده و در صورت تکرار آن در تایید‌های آتی آن را قبول نکنید.
</aside>
